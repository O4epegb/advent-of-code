import { part1, part2, isInteger } from './';
...
describe('Day2 works', () => {
    describe('part1', () => {
        it(testCase1, () => {
            expect(part1(testCase1)).toBe(18);
        });
        it('mainTestInput', () => {
            expect(part1(mainTestInput)).toBe(58975);
        });
    });

    describe('part2', () => {
        it(testCase2, () => {
            expect(part2(testCase2)).toBe(9);
        });
        it(testCase3, () => {
            expect(part2(testCase3)).toBe(5);
        });
        it('mainTestInput', () => {
            expect(part2(mainTestInput)).toBe(308);
        });
    });
